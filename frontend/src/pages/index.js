        ...
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            ">
              ...
              <div className="flex items-center justify-center mt-10 lg:self-center md:mt-8 ">

              <Image src={hero2} alt="CP" className="w-full h-auto z-10 tranform -rotate-45 lg:hidden md:inline-block md:w-full"
                  priority
                  sizes="(max-width: 768px) 100vw,
              (max-width: 1200px) 50vw,
              50vw" />

                <Image src={hero1} alt="CP" className="w-full h-auto tranform rotate-45 md:translate-x-0 lg:hidden md:inline-block md:w-full"
                  priority
                  sizes="(max-width: 768px) 100vw,
              (max-width: 1200px) 50vw,
              50vw" />
